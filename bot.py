...
def generate_summary_from_audio(audio_path: str) -> str:
    ...
    prompt = (
        "Распознай аудио голосового сообщения. Сначала представь его в читаемом, структурированном виде — как будто это человек написал сообщение вручную. "
        "Затем выдели кратко основную мысль и суть сказанного в 1–2 предложениях.\n\n"
        f"Текст сообщения:\n{transcript}"
    )
